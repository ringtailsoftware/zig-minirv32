		...
		else
		{
			...
			switch( ir & 0x7f )
			{
				...
				case 0b1101111: // JAL
				{
					...
					if( reladdy & 0x00100000 ) reladdy |= (int32_t)0xffe00000; // Sign extension.
					rval = pc + 4;
					pc = pc + (uint32_t)(reladdy - 4);
					break;
				}
				case 0b1100111: // JALR
				{
				...
				case 0b0000011: // Load
				{
					...
					else
					{
						...
						{
							//LB, LH, LW, LBU, LHU
							case 0b000: rval = (int32_t)MINIRV32_LOAD1( rsval ); break;
							case 0b001: rval = (int16_t)MINIRV32_LOAD2( rsval ); break;
							case 0b010: rval = (uint32_t)MINIRV32_LOAD4( rsval ); break;
							case 0b100: rval = (uint8_t)MINIRV32_LOAD1( rsval ); break;
							case 0b101: rval = (uint16_t)MINIRV32_LOAD2( rsval ); break;
							default: trap = (2+1);
						}
					}
					break;
				...
				case 0b0110011: // Op
				{
					...
					if( is_reg && ( ir & 0x02000000 ) )
					{
						switch( (ir>>12)&7 ) //0x02000000 = RV32M
						{
							...
							case 0b100: if( rs2 == 0 ) rval = (int32_t)-1; else rval = (int32_t)rs1 / (int32_t)rs2; break; // DIV
					...
					else
					{
						switch( (ir>>12)&7 ) // These could be either op-immediate or op commands.  Be careful.
						{
							...
							case 0b001: rval = rs1 << (rs2 % 32); break;
